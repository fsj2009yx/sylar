...
class PbDynamicMessage {
   public:
    ...
    std::shared_ptr<google::protobuf::Message> getData() const {
        return m_data;
    }
    ...
    int32_t getRepeatedInt32Value(const google::protobuf::FieldDescriptor* field,
                                  int32_t idx) const;
    void setRepeatedInt32Value(const std::string& name, int32_t idx, int32_t v);
    void setRepeatedInt32Value(const google::protobuf::FieldDescriptor* field, int32_t idx,
                               int32_t v);
    ...
    uint32_t getRepeatedUint32Value(const google::protobuf::FieldDescriptor* field,
                                    int32_t idx) const;
    void setRepeatedUint32Value(const std::string& name, int32_t idx, uint32_t v);
    void setRepeatedUint32Value(const google::protobuf::FieldDescriptor* field, int32_t idx,
                                uint32_t v);
    ...
    int64_t getRepeatedInt64Value(const google::protobuf::FieldDescriptor* field,
                                  int32_t idx) const;
    void setRepeatedInt64Value(const std::string& name, int32_t idx, int64_t v);
    void setRepeatedInt64Value(const google::protobuf::FieldDescriptor* field, int32_t idx,
                               int64_t v);
    ...
    uint64_t getRepeatedUint64Value(const google::protobuf::FieldDescriptor* field,
                                    int32_t idx) const;
    void setRepeatedUint64Value(const std::string& name, int32_t idx, uint64_t v);
    void setRepeatedUint64Value(const google::protobuf::FieldDescriptor* field, int32_t idx,
                                uint64_t v);
    ...
    void setRepeatedFloatValue(const google::protobuf::FieldDescriptor* field, int32_t idx,
                               float v);
    ...
    double getRepeatedDoubleValue(const google::protobuf::FieldDescriptor* field,
                                  int32_t idx) const;
    void setRepeatedDoubleValue(const std::string& name, int32_t idx, double v);
    void setRepeatedDoubleValue(const google::protobuf::FieldDescriptor* field, int32_t idx,
                                double v);
    ...
    std::string getRepeatedStringValue(const google::protobuf::FieldDescriptor* field,
                                       int32_t idx) const;
    void setRepeatedStringValue(const std::string& name, int32_t idx, const std::string& v);
    void setRepeatedStringValue(const google::protobuf::FieldDescriptor* field, int32_t idx,
                                const std::string& v);
    ...
    PbDynamicMessage::ptr mutableRepeatedMessage(const google::protobuf::FieldDescriptor* field,
                                                 int32_t idx);
...
class PbDynamicMessageProto {
   public:
    ...
    enum Label { OPTIONAL = 1, REQUIRED = 2, REPEATED = 3 };
    ...
    const google::protobuf::DescriptorProto& getData() const {
        return m_data;
    }
    ...
    void addMessageField(int32_t number, const std::string& name, const std::string& message_name,
                         int label = OPTIONAL);
...
class PbDynamicMessageFactory : public std::enable_shared_from_this<PbDynamicMessageFactory> {
   ...
   public:
    ...
    static PbDynamicMessageFactory::ptr CreateWithUnderlay(
        PbDynamicMessageFactory::ptr factory = nullptr);
    ...
    const google::protobuf::FileDescriptor* addPbDynamicProto(
