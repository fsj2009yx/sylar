...
class Http2Stream : public std::enable_shared_from_this<Http2Stream> {
   public:
    ...
    int32_t getSendWindow() const {
        return m_sendWindow;
    }
    int32_t getRecvWindow() const {
        return m_recvWindow;
    }

    frame_handler getFrameHandler() const {
        return m_handler;
    }
    void setFrameHandler(frame_handler v) {
        m_handler = v;
    }
    ...
    bool getIsStream() const {
        return m_isStream;
    }
    void setIsStream(bool v) {
        m_isStream = v;
    }
