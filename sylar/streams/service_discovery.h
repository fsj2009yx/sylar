...
class ServiceItemInfo {
   public:
    ...
    void setData(const std::map<std::string, std::string>& v) {
        m_datas = v;
    }
...
class IServiceDiscovery {
   public:
    ...
    const std::string& getSelfInfo() const {
        return m_selfInfo;
    }
    void setSelfInfo(const std::string& v) {
        m_selfInfo = v;
    }
    const std::string& getSelfData() const {
        return m_selfData;
    }
    void setSelfData(const std::string& v) {
        m_selfData = v;
    }
...
class ConsulServiceDiscovery : public IServiceDiscovery,
   ...
   public:
    ...
    ConsulServiceDiscovery(const std::string& name, sylar::ConsulClient::ptr client,
