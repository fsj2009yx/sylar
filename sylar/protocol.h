...
class Request : public Message {
   public:
    ...
    void setSn(uint32_t v) {
        m_sn = v;
    }
    void setCmd(uint32_t v) {
        m_cmd = v;
    }
...
class Response : public Message {
   public:
    ...
    void setResult(uint32_t v) {
        m_result = v;
    }
    void setResultStr(const std::string& v) {
        m_resultStr = v;
    }
...
class Notify : public Message {
   public:
    ...
    uint32_t getNotify() const {
        return m_notify;
    }
    void setNotify(uint32_t v) {
        m_notify = v;
    }
