...
#define SYLAR_IS_PACK(T, tt) \
    typename std::enable_if<sylar::pack::is_sylar_pack_type<T>::value, tt>::type
#define SYLAR_NOT_PACK(T, tt)                                                   \
    typename std::enable_if<!sylar::pack::is_sylar_pack_type<T>::value &&       \
                                !sylar::pack::is_sylar_out_pack_type<T>::value, \
                            tt>::type
#define SYLAR_IS_PACK_OUT(T, tt) \
    typename std::enable_if<sylar::pack::is_sylar_out_pack_type<T>::value, tt>::type
...
#define SYLAR_PACK_DECODE_OUT(i, arg) SYLAR_PASTE(SYLAR_PACK_DECODE_OUT_, arg)
...
#define SYLAR_PACK_ENCODE_OUT(i, arg) SYLAR_PASTE(SYLAR_PACK_ENCODE_OUT_, arg)
...
#define SYLAR_PACK_DECODE(i, arg) SYLAR_PASTE(SYLAR_PACK_DECODE_, arg)
...
#define SYLAR_PACK_ENCODE(i, arg) SYLAR_PASTE(SYLAR_PACK_ENCODE_, arg)
