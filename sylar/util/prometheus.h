...
class PrometheusRegistry {
   public:
    ...
    prometheus::Family<prometheus::Counter>* addCounter(
        const std::string& name, const std::string& help,
        const std::map<std::string, std::string>& labels);
    prometheus::Family<prometheus::Gauge>* addGauge(
        const std::string& name, const std::string& help,
        const std::map<std::string, std::string>& labels);
    prometheus::Family<prometheus::Histogram>* addHistogram(
        const std::string& name, const std::string& help,
        const std::map<std::string, std::string>& labels);
    prometheus::Family<prometheus::Summary>* addSummary(
        const std::string& name, const std::string& help,
        const std::map<std::string, std::string>& labels);
...
class PrometheusClient : public std::enable_shared_from_this<PrometheusClient> {
   public:
    ...
    const PrometheusClientConfig& getConfig() const {
        return m_config;
    }
