...
class KafkaProducer {
   public:
    ...
    uint64_t getTotalMsg() const {
        return m_totalMsg;
    }
    uint64_t getSuccessMsg() const {
        return m_sucessMsg;
    }
...
class KafkaProducerGroup {
   public:
    ...
    void setBrokerList(const std::string& bl) {
        m_brokerList = bl;
    }
    ...
    void setThreadName(const std::string& val) {
        m_threadName = val;
    };
...
class KafkaConsumer {
   public:
    ...
    void setCallback(message_cb cb) {
        m_cb = cb;
    }
    message_cb getCallback() const {
        return m_cb;
    }
...
class KafkaConsumerGroup {
   public:
    ...
    uint32_t getPartitionStart() const {
        return m_partitionStart;
    }
    uint32_t getPartitionEnd() const {
        return m_partitionEnd;
    }
    uint32_t getPartitionShare() const {
        return m_partitionShare;
    }

    void setThreadName(const std::string& val) {
        m_threadName = val;
    };
    void setPartitionStart(const uint32_t& val) {
        m_partitionStart = val;
    }
    void setPartitionEnd(const uint32_t& val) {
        m_partitionEnd = val;
    }
    void setPartitionShare(const uint32_t& val) {
        m_partitionShare = val;
    }
    void setTopic(const std::string& val) {
        m_topic = val;
    }

    void setOffsets(const std::map<uint32_t, int64_t>& val) {
        m_offsets = val;
    }
    void listOffsets(std::map<uint32_t, int64_t>& vs);
    void start();

    void setDefaultOffset(int32_t val) {
        m_defaultOffset = val;
    }
    ...
    int32_t getSnapInterval() const {
        return m_snapInterval;
    }
    const std::string& getSnapFilePath() const {
        return m_snapFilePath;
    }

    // seconds
    void setSnapInterval(int32_t val) {
        m_snapInterval = val;
    }
    void setSnapFilePath(const std::string& val) {
        m_snapFilePath = val;
    }
